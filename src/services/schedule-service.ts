...
export class ScheduleService {
  ...
  // Mark detail as taken: create History + set status DONE + remove suppression
  ...
  // Skip: create suppression (mute alarm, tidak ubah status)
  ...
  // Undo mark as taken: delete history + revert status to PENDING
  ...
  // Check if occurrence is suppressed (untuk alarm dispatcher)
